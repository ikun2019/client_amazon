              ...
              <div class="shipping-group">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-7 col-sm-6 col-12">
                    <div class="a-row a-spacing-base" v-for="(product, index) in getCart" :key="index">
                      <div class="row">
                        <!-- Product's photo -->
                        <div class="col-sm-3 col-3">
                          <img :src="'http://localhost:8080/' + product.photo.replace('images/', '')" style="width: 100px;" />
                        </div>
                        <!-- Product's Title -->
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">USD {{ getCartTotalPriceShipping }}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">USD {{ getCartTotalPriceShipping }}</div>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['getCart', 'getCartTotalPrice', 'getCartTotalPriceShipping'])
  },
  methods: {
